...
2) On the I/O forwarding node, aggregated Lustre client's RPCs are recorded to show the network flow.

3) On the I/O server, aggregated Lustre OSTs operations are recorded to show the disk access. 
